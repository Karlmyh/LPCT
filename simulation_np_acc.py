...
parser.add_argument('-np', type=int, help='n pub', default= 1000)
...
if __name__ == "__main__":
    ...
    for epsilon in [0.5, 1, 2, 4, 8, 1000 ]: 
        ...
        for n_train in n_train_vec:
            Parallel(n_jobs = num_jobs)(delayed(base_train)(i , epsilon, n_train, args.np, args.dis) for i in range(num_repetitions))